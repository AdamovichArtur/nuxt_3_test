...
import { type EditingDataCache, editingDataDiskCache } from './editing-data-cache';
...
export interface EditingDataService {
   ...
   */
  getEditingData(previewData: any): Promise<EditingData | undefined>;
}
...
export class BasicEditingDataService implements EditingDataService {
   ...
   */
  async getEditingData(previewData: any): Promise<EditingData | undefined> {
...
export class ServerlessEditingDataService implements EditingDataService {
  ...
  async getEditingData(previewData: any): Promise<EditingData | undefined> {
    const editingPreviewData = previewData as EditingPreviewData;
    console.log('getEditingData', editingPreviewData)
